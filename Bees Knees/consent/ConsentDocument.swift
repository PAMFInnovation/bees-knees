...
public var ConsentDocument: ORKConsentDocument {
    ...
    section16.content = "This Agreement is effective until terminated by either you or us. You may terminate this Agreement at any time, provided that you discontinue any further use of the Application. If you violate this Agreement, our permission to you to use JointCare automatically terminates. We may, in our sole discretion, terminate this Agreement and your access to any or all of JointCare, at any time and for any reason, without penalty or liability to you or any third party. In the event of your breach of this Agreement, these actions are in addition to and not in lieu or limitation of any other right or remedy that may be available to us. Upon any termination of the Agreement by either you or us, you must promptly uninstall the App on all of your devices and destroy all materials downloaded or otherwise obtained from JointCare, all documentation, and all copies of such materials and documentation."
    consentSections.append(section16)
    
    let section17 = ORKConsentSection(type: .custom)
    section17.title = "Contact"
    section17.content = "The Licensor of the Application is Sutter Health, located at 2200 River Plaza Drive, Sacramento, California 95833.  If you have any questions about JointCare, please send an email to daot1@sutterhealth.org."
