...
class ResourcesCollectionViewController: UICollectionViewController {
    ...
    fileprivate let sectionInsets: UIEdgeInsets = UIEdgeInsets(top: 30.0, left: 30.0, bottom: 30.0, right: 30.0)
    ...
    override func viewDidLoad() {
        ...
        self.collectionView?.register(ResourceCollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
